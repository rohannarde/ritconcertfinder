 ...
 */
@interface CitySearchViewController : UIViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource,UIApplicationDelegate,XMLParserDelegate>
{
